...
// détecter qu'une instance de MaliPneus tourne déjà.
constexpr wchar_t kMutexName[] =
    L"Global\\MaliPneus_SingleInstance_CCC32B06-3E8E-4D05-B29C-D990F805C408";
constexpr wchar_t kWindowTitle[] = L"MaliPneus";
...
// fenêtre (kWindowTitle) dans FindWindowW pour ne cibler que MaliPneus.
...
// l'instance de MaliPneus déjà en cours d'exécution, via WM_COPYDATA,
// puis tente de la ramener au premier plan.
...
int APIENTRY wWinMain(_In_ HINSTANCE instance, _In_opt_ HINSTANCE prev,
  ...
  // Instance unique : si MaliPneus tourne déjà, on lui transmet le
