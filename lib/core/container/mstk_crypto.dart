...
abstract final class MstkCrypto {
  ...
  /// de `package:cryptography` — mesuré à 87 ms contre 3,9 s pour
  /// déchiffrer 33 Mo) ; ailleurs, repli sur `package:cryptography`.
  /// Les deux implémentations sont interopérables (AES-256-GCM
  /// standard) : un fichier chiffré par l'une se déchiffre par l'autre.
