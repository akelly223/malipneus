...
const _entries = <_Entry>[
  ...
  _Entry('Personnel', Icons.badge_rounded, '/employees'),
  _Entry('Paie', Icons.payments_rounded, '/payroll'),
  _Entry('Commissions', Icons.percent_rounded, '/commissions'),
  _Entry('Dépenses', Icons.request_quote_rounded, '/expenses'),
  _Entry('Chargements', Icons.inventory_rounded, '/loadings'),
