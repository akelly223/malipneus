...
import 'package:mali_pneus/core/constants/db_constants.dart';
import 'package:mali_pneus/core/container/mstk_container_service.dart';
import 'package:mali_pneus/core/services/mstk_migration_service.dart';
...
void main() {
  ...
  test('migrer() copie le contenu du dossier legacy sans le modifier',
    ...
    // Fabrique un dossier legacy "MaliPneus" avec une fausse
    // base et un fichier logo, comme le ferait l'ancien flux.
    final dossierLegacy =
        Directory(p.join(docDir.path, 'MaliPneus'));
