...
import 'package:mali_pneus/core/container/mstk_exceptions.dart';
...
void main() {
  ...
  test('créer → écrire du contenu → sauvegarder → fermer → rouvrir : '
    ...
    final donneesSqlite =
        File(p.join(ouvert1.dossierTravail.path, 'mali_pneus.sqlite'));
    ...
    final relu = await File(
            p.join(ouvert2.dossierTravail.path, 'mali_pneus.sqlite'))
        .readAsBytes();
